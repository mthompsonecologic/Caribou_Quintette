...
for(i in 1:length(BRBs_BM_WI)){
  ...
  st_write(BRBs_BM_WI[[i]], paste0(here("BRB_UDs"), "/", names(BRBs_BM_WI[[i]])))
}

## the loop above as an apply:
#BRBs_BM_WI <- lapply(BRBs_BM_WI, st_as_sf(BRBs_BM_WI))
#lapply(BRBs_BM_WI, st_write(BRBs_BM_WI, paste0(here("BRB_UDs"), "/", names(BRBs_BM_WI))))
...
for(i in 1:length(BRBs_BM_CA)){
  BRBs_BM_CA[[i]] <-st_as_sf(BRBs_BM_CA[[i]])
  st_write(BRBs_BM_CA[[i]], paste0(here("BRB_UDs"), "/", names(BRBs_BM_CA[[i]])))
}

## the loop above as an apply:
#BRBs_BM_CA <- lapply(BRBs_BM_CA, st_as_sf(BRBs_BM_CA))
#lapply(BRBs_BM_CA, st_write(BRBs_BM_CA, paste0(here("BRB_UDs"), "/", names(BRBs_BM_CA))))
...
for(i in 1:length(BRBs_BM_SU)){
  BRBs_BM_SU[[i]] <-st_as_sf(BRBs_BM_SU[[i]])
  st_write(BRBs_BM_SU[[i]], paste0(here("BRB_UDs"), "/", names(BRBs_BM_SU[[i]])))
}

## the loop above as an apply:
#BRBs_BM_SU <- lapply(BRBs_BM_SU, st_as_sf(BRBs_BM_SU))
#lapply(BRBs_BM_SU, st_write(BRBs_BM_SU, paste0(here("BRB_UDs"), "/", names(BRBs_BM_SU))))
...
for(i in 1:length(BRBs_BM_RU)){
  BRBs_BM_RU[[i]] <-st_as_sf(BRBs_BM_RU[[i]])
  st_write(BRBs_BM_RU[[i]], paste0(here("BRB_UDs"), "/", names(BRBs_BM_RU[[i]])))
}

## the loop above as an apply:
#BRBs_BM_RU <- lapply(BRBs_BM_RU, st_as_sf(BRBs_BM_RU))
#lapply(BRBs_BM_RU, st_write(BRBs_BM_RU, paste0(here("BRB_UDs"), "/", names(BRBs_BM_RU))))
...
for(i in 1:length(BRBs_TR_RU)){
  BRBs_TR_RU[[i]] <-st_as_sf(BRBs_TR_RU[[i]])
  st_write(BRBs_TR_RU[[i]], paste0(here("BRB_UDs"), "/", names(BRBs_TR_RU[[i]])))
}

## the loop above as an apply:
#BRBs_TR_RU <- lapply(BRBs_TR_RU, st_as_sf(BRBs_TR_RU))
#lapply(BRBs_TR_RU, st_write(BRBs_TR_RU, paste0(here("BRB_UDs"), "/", names(BRBs_TR_RU))))
