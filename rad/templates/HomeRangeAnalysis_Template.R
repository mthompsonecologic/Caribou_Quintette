...
gcinfo(TRUE)
wd <- getwd()
newwd <- paste("/gpfs/scratch/an-rdorador/sat-caribou", "data", "**SA**/**SEASON**/Job_**JOBID**/", sep = "/")
setwd(newwd)
...
# print("#############################################################################")
# # Save the output.
write.csv(BRB_area, paste("BRB_area/", "/**SA**_**SEASON**_BRB_areas.csv", sep=""), row.names = FALSE)
