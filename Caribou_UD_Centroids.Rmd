...
see: https://cran.r-project.org/web/packages/stampr/stampr.pdf
     https://www.jstatsoft.org/article/download/v084c01/1214 
...
## Stampr package. This works for some of the UD polygon comparisons.
## These loops were working, but it requires troubleshooting.
## However, you can look at individual cases (e.g., n = 2 in BM works).
## Retained for future exploratory study of UD movements.
