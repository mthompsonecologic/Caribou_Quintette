...
This code chunk calculates the centriod of the BRB homerange estimation for each individual within year and season. These centroids are subsequently used to calculate the individual BRB distance to the aggregate centroid, by season and by year. It takes a large amount of cpu time to load in the individual shapefiles.
